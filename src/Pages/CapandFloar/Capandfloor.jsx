        ...
        <ThemeProvider theme={theme}>   
          <Box component='form'  onSubmit={handleSubmit}>
            ...
            <Grid container spacing={1} className='mainGrid-2' >
              <InputField label={'Notional Amount'}  type={'number'}/>
              ...
              <InputField label={'Premium'}  type={'number'}/>
              <InputField label={'Premium FX'}  type={'number'}/>
              <Dropdown name={Type} label={Type.label} />
              <Dropdown name={Settlement} label={Settlement.label} />
              <InputField label={'Exercise Rate'}  type={'number'}/>
              <InputField label={'Accural Rate Scale Factor'} classname = {'lowsize'}  type={'number'}/>
              ...
              <InputField label={'First Reset Date '}  type={'number'}/>
              <Dropdown name={PaymentFrequency} label={'Reset Frequency'} />
              <Dropdown name={PaymentFrequency} label={'Reset Day Count'} />
              <InputField label={'Lookback days'}  type={'number'}/>
              <InputField label={'Initial spread (bps)'}  type={'number'}/>
              <Dropdown name={BenchmarkIndex} label={BenchmarkIndex.label} />
              <Dropdown name={BusinessDateAdjustmentRestBdc} label={'Reset BDC'} />
